                                ...
                                <div className="main-content inloginp">
                                    <form action="#">
                                        ...
                                        <div className="or-content">
                                            ...
                                            <a href="#" className="default-btn reverse"><img
                                                src="assets/images/login/google.png" alt="google" /> <span>Sign Up with Google</span></a>
                                            <p className="or-signup"> Don't have an account? <a href="register.html">Sign
                                                up here</a></p>
                                        </div>
                                    </form>
                                </div>
